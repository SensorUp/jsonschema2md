  ...
  return {
    ...
    get: (target, prop, receiver) => {
      ...
      if (typeof retval === 'object' && retval !== null) {
        ...
        if (retval.if && retval.if.properties) {
          // this is a numbered anyOf/oneOf child that terminates in the doc tree
          // lift if.properties.*.title to retval.title
          const conditionValue = Object.keys(retval.if.properties)[0];
          retval.title = `${conditionValue} is ${retval.if.properties[conditionValue].const}`;
